...
<html lang="en">
    <head>
        ...
        <title>OurFin -  Input Data Outcome</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Input Data Outcome</h1>
                        ...
                        <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
  <form action="engine/prosesinputoutcome.php?function=create" method="POST">
...
$query = "SELECT * FROM income WHERE jenis = 'Pengeluaran'";
$result = mysqli_query($conn, $query);
...
<tr>
    ...
    <td>
    <a href="engine/prosesinputoutcome.php?id=<?php echo $row['id']; ?>&aksi=delete" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Delete</a>
    </td>
</tr>
