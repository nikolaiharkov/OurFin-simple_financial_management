...
<html lang="en">
    <head>
        ...
        <title>OurFin -  Kategori Income</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Kategori Income</h1>
                        ...
                        <div class="col-lg-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Input Kategori Income
                                    </div>
                                    <div class="card-body">
  <form action="engine/proseskatincome.php?function=create" method="POST">
    <div class="input-group mb-3">
      <input type="text" class="form-control" placeholder="Masukkan Nama Kategori Income" name="namakategoriincome">
    ...
    ?>
        <tr>
            ...
            <td>
                <a href="engine/proseskatincome.php?id=<?php echo $row['id']; ?>&aksi=delete" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Delete</a>
            </td>
        </tr>
    <?php
    }
