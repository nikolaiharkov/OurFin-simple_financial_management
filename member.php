...
<html lang="en">
    <head>
        ...
        <title>OurFin -  Member Area</title>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
  <form action="engine/prosesmember.php?function=create" method="POST">
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td>
                    <a href="engine/prosesmember.php?id=<?php echo $row['id']; ?>&function=delete" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Delete</a>
                </td>
            </tr>
        <?php
        }
